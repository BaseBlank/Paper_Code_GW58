...
class customdataset_sr_gt(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sr_result = imgproc.image_resize(sr_result, self.upscale_factor)  # [H,W,C], u,v,dir
...
sr_directory = 'F:/model_generator/No_Heating/center_blockage_0.7/test_use/lr_dir'  # Actually low-resolution data is used here
