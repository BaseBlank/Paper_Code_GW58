...
def Reconstruction_Results_Error_Cal(real_results_files, reconstruction_results_files,
    ...
    return Re_error_record.mean().astype(np.float32), Re_error_record


error_result_path = "F:\\model_generator\\No_Heating\\center_blockage_0.7\\test_use\\2DArray\\error_matrix_m"

error_linear_mean, error_linear = Reconstruction_Results_Error_Cal(real_results_files=file_GT,
...
error_cubic_mean, error_cubic = Reconstruction_Results_Error_Cal(real_results_files=file_GT,
...
error_SR_mean, error_SR = Reconstruction_Results_Error_Cal(real_results_files=file_GT,
